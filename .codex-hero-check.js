...
function Hero() {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const updateSlides = () => {
      ...
      hero.querySelectorAll(".heroMedia img").forEach((image, index) => {
    ...
    const requestUpdate = () => {
      if (frameId) return;
      frameId = window.requestAnimationFrame(updateSlides);
    };
    updateSlides();
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    ...
    /* @__PURE__ */ import_react.default.createElement("div", { className: "heroStage" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "heroMedia", "aria-hidden": "true" }, heroImages.map((image, index) => /* @__PURE__ */ import_react.default.createElement(
      "img",
      {
        src: image,
        alt: "",
    ...
    ))), /* @__PURE__ */ import_react.default.createElement("div", { className: "heroOverlay" }), /* @__PURE__ */ import_react.default.createElement("div", { className: "heroBlur" }), /* @__PURE__ */ import_react.default.createElement("div", { className: "heroDots", "aria-label": "Choose hero photograph" }, heroImages.map((image, index) => /* @__PURE__ */ import_react.default.createElement(
      "button",
      {
        type: "button",
    ...
    ))), /* @__PURE__ */ import_react.default.createElement("div", { className: "heroContent" }, /* @__PURE__ */ import_react.default.createElement("p", { className: "heroEyebrow" }, "Wedding Photography"), /* @__PURE__ */ import_react.default.createElement("h1", { className: "heroTitle" }, /* @__PURE__ */ import_react.default.createElement("span", null, "Wedding photographs"), /* @__PURE__ */ import_react.default.createElement("span", null, "that feel like you.")), /* @__PURE__ */ import_react.default.createElement("p", { className: "heroDescription" }, "Honest moments, beautiful details, and memories you can return to for a lifetime."), /* @__PURE__ */ import_react.default.createElement("div", { className: "heroActions" }, /* @__PURE__ */ import_react.default.createElement("a", { href: "#portfolio", className: "heroBtn heroBtnDark" }, "View Gallery ", /* @__PURE__ */ import_react.default.createElement("span", null, "\u203A")), /* @__PURE__ */ import_react.default.createElement("a", { href: "#contact", className: "heroBtn heroBtnOutline" }, "Check Availability ", /* @__PURE__ */ import_react.default.createElement("span", null, "\u203A")))))
  );
}
