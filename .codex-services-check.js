...
// src/components/ServicesStory/ServicesStory.jsx
...
var storyServices = [
  {
    ...services[0],
    storyText: "Elegantly composed and natural images that reflect your unique love story. With a focus on candid emotion and timeless portraits, we preserve every celebration as vividly as it was lived."
  },
  {
    ...services[1],
    storyText: "Cinematic films shaped through movement, sound, and honest emotion. From quiet preparations to joyful celebrations, every chapter is crafted into a story you can experience again."
  },
  {
    ...services[2],
    storyText: "Relaxed portrait sessions created around your connection, personality, and chosen location. We guide every detail while leaving space for the most natural moments to unfold."
  },
  {
    ...services[4],
    storyText: "Thoughtful homecoming coverage that brings together ceremony, family, portraits, and celebration. Every meaningful moment is documented with elegance, warmth, and genuine care."
  }
];
function ServicesStory() {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const updateActiveStory = () => {
      ...
      const sticky = section.querySelector(".servicesStorySticky");
      ...
      const travelled = Math.min(Math.max(-bounds.top, 0), scrollDistance);
      const progress = travelled / scrollDistance;
      const nextIndex = Math.min(
        storyServices.length - 1,
        Math.floor(progress * storyServices.length)
      );
      setActiveIndex((current) => current === nextIndex ? current : nextIndex);
      frameId = 0;
    };
    const onScroll = () => {
      if (!frameId) frameId = window.requestAnimationFrame(updateActiveStory);
    };
    updateActiveStory();
  ...
  return /* @__PURE__ */ import_react.default.createElement(
    "section",
    {
      className: "servicesStory",
      ref: sectionRef,
      "aria-label": "JB WEDDINGS services"
    },
    /* @__PURE__ */ import_react.default.createElement("div", { className: "servicesStorySticky" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "servicesStoryLayout" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "servicesStoryVisual" }, storyServices.map((service, index) => /* @__PURE__ */ import_react.default.createElement(
      "figure",
      {
        className: `servicesStoryFrame${index === activeIndex ? " is-active" : ""}`,
        "aria-hidden": index !== activeIndex,
        key: service.title
      },
      /* @__PURE__ */ import_react.default.createElement("img", { src: service.image, alt: index === activeIndex ? service.alt : "" })
    ))), /* @__PURE__ */ import_react.default.createElement("div", { className: "servicesStoryContent" }, storyServices.map((service, index) => /* @__PURE__ */ import_react.default.createElement(
      "article",
      {
        className: `servicesStoryCopy${index === activeIndex ? " is-active" : ""}`,
        "aria-hidden": index !== activeIndex,
        key: service.title
      },
      /* @__PURE__ */ import_react.default.createElement("h2", null, service.title),
      /* @__PURE__ */ import_react.default.createElement("p", { className: "servicesStoryText" }, service.storyText)
    )))))
  );
}
var ServicesStory_default = ServicesStory;
export {
  ServicesStory_default as default
};
